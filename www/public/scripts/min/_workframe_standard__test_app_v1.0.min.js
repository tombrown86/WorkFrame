...
return jQuery;}));;function _workframe_show_errors(form_id,errors){$("#"+formid+"_errors").html('').show();for(i in errors){$("#"+formid+"_errors").append("<li><strong>"+(h(errors[i].error_message))+"</strong><span></span></li>");}};function _workframe_show_errors(form_id,errors){$("#"+formid+"__wf_errors").html('').show();$("#"+formid+" .wf_error_container").html('').hide();$("#"+form_id+" .wf_invalid_field").removeClass('wf_invalid_field');for(i in errors){$("#"+form_id+"__"+errors[i]['field']).addClass('wf_invalid_field');var error_details='';if("error_details"in errors[i]){error_details="<span>"+(h(errors[i]['error_details']))+"</span>";}
$("#"+formid+"__wf_errors").append("<li><strong>"+(h(errors[i]['error_message']))+"</strong>"+error_details+"</li>");$("#"+form_id+"__"+errors[i]['field']+"__wf_error_container").html('invalid_field').show();}};